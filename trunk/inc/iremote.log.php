...
class IREMOTE_Log {
	...
	public function add_item( $item ) {
		...
		update_option( 'iremo_log', $items );
	}

	public function get_items() {

		return get_option( 'iremo_log', array() );
	}

	public function delete_items() {

		delete_option( 'iremo_log' );
	}
}

add_action( 'plugins_loaded', array( 'IREMOTE_Log', 'get_instance' ) );